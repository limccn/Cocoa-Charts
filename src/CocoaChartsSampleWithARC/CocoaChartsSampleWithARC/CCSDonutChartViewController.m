...
@interface CCSDonutChartViewController ()

@end

@implementation CCSDonutChartViewController
...
- (void)viewDidLoad {
    ...
    CCSDonutChart *piechart = [[CCSDonutChart alloc] initWithFrame:CGRectMake(0, 80, 320, 320)];
